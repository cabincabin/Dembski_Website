...
d3.select(".sculpt").on("mouseover", function(d){
    ...
    open();
    d3.select(".show").append("div");
    d3.select(".show").append("div").append("img").attr("src", "https://media.giphy.com/media/llOVFNduIrr7Kx6UoC/giphy.gif").attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
        "    border-radius: 50%;\n" +
        "    max-width:1px;\n").transition(500).attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
        "    border-radius: 50%;\n" +
        "    max-width:300px;");
    d3.select(".show").append("div").append("img").attr("src", "https://media.giphy.com/media/d6ET6xum3YDPvh99Ns/giphy.gif").attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
        "    border-radius: 50%;\n" +
        "    max-width:1px;\n").transition(500).attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
        "    border-radius: 50%;\n" +
        "    max-width:300px;");
    d3.select(".show").append("div").append("img").attr("src", "https://media.giphy.com/media/RhkdJWwsLXDVBTdiL4/giphy.gif").attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
        "    border-radius: 50%;\n" +
        "    max-width:1px;\n").transition(500).attr("style","padding-top: 65px;\n" +
        "    padding-bottom: 65px;\n" +
...
function open() {
    ...
    d3.select(".show").transition(600).attr("style", "height:"+(screen.height-d3.select(".show").node().offsetTop )+"px;");
}
function closed() {
    d3.select(".show").transition(600).attr("style", "height:0px;");
